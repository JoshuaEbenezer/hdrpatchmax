...
def aggd_features(imdata):
    #flatten imdata
    imdata = np.reshape(imdata, (len(imdata.flat),))
...
def compute_image_ms_transform(image, C=1, avg_window=None, extend_mode='constant'):
